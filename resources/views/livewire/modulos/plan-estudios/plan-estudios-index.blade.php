    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <x-diseñotabla.tabla>          
            ...
            <div class="px-6 py-4 flex items-center border border-gray-200 shadow-lg">
                ...
                <x-buscadortabla.buscador :type="$type='PlanEstudios'" />

                {{-- BOTON CREAR NUEVA ENTIDAD --}}
                @livewire('modulos.plan-estudios.plan-estudios-create')                   
            </div>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex item-center">
                                    ...
                                    {{-- Editar --}}
                                    <button wire:click="show({{$planEstudio->id}})" class="focus:outline-none w-7 mr-2 border-gray-900 bg-yellow-500 text-white border rounded-lg p-1 transform hover:text-purple-500 hover:bg-yellow-700 hover:scale-110">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
