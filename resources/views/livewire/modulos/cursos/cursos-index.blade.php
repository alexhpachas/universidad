    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <x-diseñotabla.tabla>          
            ...
            <div class="px-6 py-4 flex items-center">
                ...
                <x-buscadortabla.buscador :type="$type='Cursos'" />

                {{-- BOTON CREAR NUEVA ENTIDAD --}}
                @livewire('modulos.cursos.cursos-create')                 
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th wire:click="order('horas_teoricas')" scope="col"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Hrs Teoricas
                            @if ($this->campo !='horas_teoricas')
                                <i class="float-right fas fa-sort mt-1"></i>                                
                            @else
                                @if ($this->direccion=='asc')
                                    <i class="float-right fas fa-sort-up mt-1"></i>
                        ...
                        <th wire:click="order('horas_practicas')" scope="col"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Hrs Practicas
                            @if ($this->campo !='horas_practicas')
                                <i class="float-right fas fa-sort mt-1"></i>                                
                            @else
                                @if ($this->direccion=='asc')
                                    <i class="float-right fas fa-sort-up mt-1"></i>
                        ...
                        <th wire:click="order('creditos')" scope="col"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Creditos
                            @if ($this->campo !='creditos')
                                <i class="float-right fas fa-sort mt-1"></i>                                
                            @else
                                @if ($this->direccion=='asc')
                                    <i class="float-right fas fa-sort-up mt-1"></i>
                        ...
                        <th wire:click="order('tipo')" scope="col"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Tipo
                            @if ($this->campo !='tipo')
                                <i class="float-right fas fa-sort mt-1"></i>                                
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex item-center">
                                    ...
                                    {{-- Editar --}}
                                    <div>
                                        @livewire('modulos.cursos.cursos-update', ['curso' => $curso], key($curso->id))
                                    </div>
                           ...
                           {{--  <td class="px-6 py-4">
                                <div class="flex item-center">
                                    <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        <svg class="text-blue-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                        </svg>
                                    </div>
                                    <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        <svg class="text-yellow-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
